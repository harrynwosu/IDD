...
const Footer = () => {
    const footerLinks = [
        ...
        },
        {
            ...
            links: [
                ...
                {
                    name: 'Customer Orgs',
                    url: 'https://www.keystonealliance.org/member-orgs',
                },
    ...
    const socialLinks = [
        ...
        {
            name: 'GitHub',
            url: 'https://github.com/harrynwosu/IDD',
            icon: (
                <path
                    fillRule='evenodd'
        ...
        <footer className='footer'>
            <div className='footer-container'>
                <div className='footer-top'>
                    <h2 className='footer-logo'>Keystone Alliance</h2>
                ...
                <div className='footer-bottom'>
                    ...
                    <p className='copyright'>
                        © 2025 Keystone Alliance. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
